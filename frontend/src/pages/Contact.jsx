export default function Contact() {
  return (
    <div class="max-w-5xl max-lg:max-w-3xl mx-auto bg-white pt-24 p-4">
            ...
            <ul class="flex flex-wrap gap-y-4 gap-x-5 mt-16">
              <li class="bg-slate-200 hover:bg-white h-9 w-9 rounded-full flex items-center justify-center shrink-0">
                <a href="javascript:void(0)">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-[18px] h-[18px] fill-slate-900"
                    viewBox="0 0 24 24"
                  >
                    <path
            ...
            <div class="grid md:grid-cols-2 gap-8">
              ...
              <div class="relative flex items-center col-span-full">
                <textarea
                  ...
                  class="px-2 pt-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-slate-900 outline-none"
                ></textarea>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#bbb"
                ...
                >
                  <defs>
                    <clipPath id="a" clipPathUnits="userSpaceOnUse">
                      <path d="M0 512h512V0H0Z" data-original="#ce0c0c"></path>
                    </clipPath>
                  </defs>
                  <g
                    clip-path="url(#a)"
              ...
              <div class="col-span-full">
                <h6 class="text-[15px] text-slate-900 font-medium">
                  Select Subject
                </h6>
                <div class="flex flex-wrap gap-6 mt-4">
                  <div class="flex items-center">
                    ...
                    <p class="text-sm text-slate-600 ml-3">General Inquiry</p>
                  </div>
                  <div class="flex items-center">
                    <input
                      id="radio2"
                    ...
                    <p class="text-sm text-slate-600 ml-3">Technical Support</p>
                  </div>
                  <div class="flex items-center">
                    <input
                      id="radio3"
                    ...
                    <p class="text-sm text-slate-600 ml-3">Website Feedback</p>
                  </div>
                </div>
              </div>
            </div>
